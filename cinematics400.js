...
function islandsHtml(cls=''){return `<div class="cin-islands ${cls}"><i class="cin-island i1"></i><i class="cin-island i2"></i><i class="cin-island i3"></i><i class="cin-island i4"></i><i class="cin-island i5"></i><span class="cin-route r1"></span><span class="cin-route r2"></span><span class="cin-route r3"></span><span class="cin-route r4"></span></div>`}
function homeHtml(withCast=true){return `<div class="cin-home-scene"><div class="cin-home-cloud c1"></div><div class="cin-home-cloud c2"></div><div class="cin-home-island"><div class="cin-home-grass"></div><div class="cin-cottage"><i class="roof"></i><i class="door"></i></div><i class="cin-tree"></i>${withCast?`<div class="cin-home-cast">${character('Pippa','pippa')}${character('Bramble','bramble')}${character('Rowan','rowan')}${character('Pip','pip')}${character('Tansy','tansy')}</div>`:''}</div></div>`}
...
function networkHtml(mode=''){return `<div class="cin-network ${mode}"><i class="node n1"><span>MEADOWS</span></i><i class="node n2"><span>LANTERN</span></i><i class="node n3"><span>LODESTONE</span></i><i class="node n4"><span>KEEP</span></i><i class="node n5"><span>PRISM</span></i><i class="node n6"><span>COPPERLINE</span></i><i class="node n7"><span>STORMSWITCH</span></i><i class="node n8"><span>CROWN</span></i><span class="wire w1"></span><span class="wire w2"></span><span class="wire w3"></span><span class="wire w4"></span><span class="wire w5"></span><span class="wire w6"></span><span class="wire w7"></span></div>`}
function visualHtml(type){
 if(type==='archipelago')return islandsHtml('wide');
 if(type==='little-home')return homeHtml(true);
 ...
 if(type==='morning')return `${homeHtml(false)}<div class="cin-breakfast-route"><span class="old-line"></span><i class="basket">▣</i><i class="miss">×</i></div>${character('Pippa','morning-pippa')}${character('Rowan','morning-rowan')}${character('Pip','morning-pip')}${character('Tansy','morning-tansy')}`;
 ...
 if(type==='porch')return `<div class="cin-telescope"><i class="tube"></i><i class="lens"></i></div>${character('Tansy','telescope-tansy')}<div class="cin-distant-porch"><i></i><b>•</b></div>`;
 ...
 if(type==='new-route')return `${islandsHtml('new')}<div class="cin-new-route-pen"></div>`;
 ...
 if(type==='automation')return `<div class="cin-automation"><div class="hand-map">${mapSheets('tiny')}</div><div class="machine"><i class="gear g1">✦</i><i class="gear g2">✦</i><span class="fixed-line"></span></div></div>`;
 if(type==='frozen-network')return `${islandsHtml('frozen')}<div class="cin-frozen-lines"><i></i><i></i><i></i></div>`;
 if(type==='brand-new-route')return `${islandsHtml('brand-new')}<div class="cin-compass small"><i></i></div>`;
 if(type==='signals')return networkHtml('signals');
 if(type==='keepsakes')return `<div class="cin-keepsakes"><i>📫<small>MEADOWS</small></i><i>⚑<small>LANTERN</small></i><i>⚓<small>LODESTONE</small></i><i>◇<small>KEEP</small></i><i>⌖<small>PRISM</small></i><i>⌁<small>COPPERLINE</small></i><i>▣<small>STORMSWITCH</small></i></div>`;
 ...
 if(type==='homeward-network')return `<div class="cin-homeward-wrap">${homeHtml(true)}${networkHtml('mini')}</div>`;
 return islandsHtml();
}
