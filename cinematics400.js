...
const CINEMATICS={
 opening:{
  ...
  beats:[
   ...
   {label:'This Morning',visual:'morning',lines:[['Pippa','That route worked yesterday.'],['Rowan','Little Home moved farther than usual overnight.'],['Pip','So breakfast is a puzzle now?'],['Tansy','Breakfast is urgently a puzzle now.'],['Narrator','Start with the morning route. What Little Home learns here can travel with the next report, the next crew, and the next island.']]}
  ]
 },
 'across-drift':{
