...
const CINEMATICS={
 opening:{
  ...
  beats:[
   ...
   {label:'Little Home',visual:'little-home',lines:[['Narrator','This is Little Home, a shared household where five very different sets of eyes keep catching different parts of the same day.'],['Tansy','It was one basket.'],['Pip','It was an expedition basket.']]},
   ...
   {label:'You Are the Waykeeper',visual:'waykeeper',lines:[['Narrator','At Little Home, Pippa’s broken schedules, Rowan’s drift notes, Bramble’s missed deliveries, and Pip and Tansy’s finds all point to one pattern: the Skyway is using routes for islands that have already moved.'],['Pippa','We can show you every place yesterday stopped working.'],['Rowan','You can help us find where those routes should go now.']]},
   {label:'The Helper Crew',visual:'helper-crew',lines:[['Narrator','Word travels outward. Meadow neighbors send observations, volunteers test safe stops, and each island tends the Skyway hardware it knows best. Little Home gathers the reports so the Waykeeper can connect them.'],['Bramble','Everybody knows a piece of the route. We just need to put the pieces together.']]},
   ...
   {label:'This Morning',visual:'morning',lines:[['Pippa','That route worked yesterday.'],['Rowan','Little Home moved farther than usual overnight.'],['Pip','So breakfast is a puzzle now?'],['Tansy','Breakfast is urgently a puzzle now.'],['Narrator','Start here. Fix Little Home’s morning routes, compare each repair with the reports arriving from Sunpetal, and find out whether this is one strange morning or something much larger.']]}
  ]
 },
 'across-drift':{
