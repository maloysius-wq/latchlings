...
new='@media(max-width:350px){.mastery-guide{margin-left:0;padding:2px 5px;font-size:8.5px;letter-spacing:-.01em}.story-card-line em{font-size:12px}}\n@media(max-height:600px){#game .mechanic-note.mechanic-chip{margin:0 auto;padding:5px 8px}.mastery-guide{font-size:8.5px;padding:2px 5px}#game .controls{padding-top:0}.dpad{width:min(190px,43.1vw);height:min(190px,43.1vw)}}'
