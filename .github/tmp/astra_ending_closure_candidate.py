...
@media(max-height:640px){.ending-network-stage .ending-skyway-node b{display:none}.ending-home-focus{inset:6% 5% 3%}.ending-skyway-node{scale:.86}.ending-skyway-node.node-home{scale:.9}}
