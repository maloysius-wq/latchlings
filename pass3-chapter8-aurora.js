...
(function(){
  ...
  function showChapterEightReward(stars,starRow,moveWord,lev){
    modal(`<section class="chapter-reward-card chapter-eight-reward" aria-label="Aurora Crown joins the living Skyway"><div class="chapter-reward-kicker">Tomorrow's route is already moving</div><h2>Skyway Restored</h2><div class="chapter-reward-postcard aurora-reward-postcard" role="img" aria-label="Old and new route lights meet at Aurora Crown, continue outward to several communities, and leave no single route or master switch at the center"><i class="aurora-reward-crown"></i><i class="aurora-reward-beacon"></i><i class="aurora-reward-route r1"></i><i class="aurora-reward-route r2"></i><i class="aurora-reward-route r3"></i><i class="aurora-reward-route r4"></i><i class="aurora-reward-island i1"></i><i class="aurora-reward-island i2"></i><i class="aurora-reward-island i3"></i><i class="aurora-reward-island i4"></i></div><p class="chapter-reward-result">Aurora Crown is connected, but it is not a master switch and this is not a final map. Old routes and brand-new routes now belong to the same living Skyway, tended by communities that keep watching the drift, sharing what changes, and making tomorrow's route fit tomorrow.</p><div class="win-stars chapter-reward-stars" aria-label="${stars} stars earned">${starRow}</div><div class="chapter-reward-score">${moveWord(movesUsed)} · Perfect route: ${moveWord(lev.optimal)}</div><div class="modal-actions"><button class="primary-small" id="chapterEightRewardHome">Visit Little Home</button><button class="secondary-small" id="chapterEightRewardFinish">See the living Skyway</button></div></section>`);
